...
/**
 * 
 * L'interface pour calculer la somme de consommation de client
 *
 */
public class AccountDetail extends JDialog implements ActionListener{
	...
	EmpModel em;
	Window2 window2;
	public AccountDetail(Accounts a,Window2 window2)
	{
		...
		jl1=new JLabel("This is you bill：");
		p1.add(jl1);
...
//				sum+=Integer.valueOf(String.valueOf(num[i]*price[i])).intValue();
			...
			String [] params2 = {bookid};
			String sql3="delete from bookdetail where bookid=?";
			em.UpdateModel(sql3, params2);
			JOptionPane.showMessageDialog(this, "The total amount of your consumption: "+df.format(sum)+"$");
